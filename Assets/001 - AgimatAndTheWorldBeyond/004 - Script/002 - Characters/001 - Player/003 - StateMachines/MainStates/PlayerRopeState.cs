...
public class PlayerRopeState : PlayerStatemachine
{
    ...
    public void ExitRopeState()
    {
        ...
        statemachineController.core.ropePlayerController.currentRopeList.Clear();
        statemachineController.core.ropePlayerController.currentRopeIndex = 0;
    }
}
